...
TANKMETER_MIN_SIZE_FACTOR = 3
TANKMETER_MAX_SIZE_FACTOR = 5
TANKMETER_DEFAULT_SIZE_FACTOR = 4
TANKMETER_WIDTH = 45
TANKMETER_MARGIN = 15
TANKMETER_BORDER_WIDTH = 2
TANKMETER_BORDER_RADIUS = 20
TANKMETER_BORDER_HACK_INFLATE = 12
TANKMETER_BORDER_HACK_WIDTH = 7
TANKMETER_MARK_WIDTH = 2
TANKMETER_BODY_BG_COLOR   = TOOLBOX_BODY_BG_COLOR
TANKMETER_BG_GREEN_COLOR  = COLOR_GREEN_B
TANKMETER_BG_RED_COLOR    = COLOR_RED_B
TANKMETER_BG_YELLOW_COLOR = COLOR_YELLOW_B
TANKMETER_BORDER_COLOR    = COLOR_GRAY_C
